...
export class ComponentManager
{
    ...
    private readonly _MenusMap = new Map<string, MapVal<ComponentManager.MenuStringCode | ComponentManager.MenuUserCode, ComponentManager.MenuOptions>>();
